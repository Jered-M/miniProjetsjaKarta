...
Write-Host "Creation WAR..." -ForegroundColor Cyan
...
Write-Host "Dedeploiement ancien..." -ForegroundColor Cyan
& "$GlassFishHome\bin\asadmin.bat" undeploy miniProjet-1.0 2>&1 | Out-Null
Start-Sleep -Seconds 2

Write-Host "Redeploiement..." -ForegroundColor Cyan
& "$GlassFishHome\bin\asadmin.bat" deploy --force $warPath 2>&1 | Select-String "deployed|failure"

Write-Host "Deploiement termine" -ForegroundColor Green
Write-Host "Acces: http://localhost:8080/miniProjet/" -ForegroundColor Green
